        ...
        return (
            <Screen withoutTopEdge noHorizontalPadding>
                ...
                <View style={styles.container}>
                    <CText mb={15} size="lg_medium" color="purple1">Invite doctor</CText>
                    <ControlledInput
                        control={control}
                    ...
                    <CButton
                        ...
                        onPress={handleSubmit(() => {
                            core.inviteDoctor.execute({email:control._formValues.email}).then(r=>{
                                console.log(r)
                                r ? Alert.alert(
                                    'Invitation sent!',
                    ...
                    />
                    <CText mb={15} mt={25} size="lg_medium" color="purple1">Doctors list</CText>
                        ...
                        <View style={styles.profileHeader} key={index}>
                            ...
                            >
                                <CText size="xl_bold" color="white">
                                    {item.name.split(' ')[0][0].toUpperCase()+item.name.split(' ')[1][0].toUpperCase()}
                                </CText>
                            </View>
