...
const EmergencyScreen = () => {
  const [emergency, setEmergency] = useState<Record<
    string,
    string | null
  > | null>(null);
  ...
  return (
    <Screen withoutTopEdge noHorizontalPadding>
      <Header
        hasBackButton
        text="common.emergency"
        backgroundColor={Colors.lightPurple}
      />
      {emergency ? (
        <View style={styles.container}>
          <EmergencyButton
            number={emergency.ambulance ?? 'N/A'}
            title={'Ambulance'}
            icon={
              <Icon
                type="ionicon"
        ...
        <CText mt={20} size={'sm_light'}>
          No emergency details found for you please update your number or your
          country.
        </CText>
      )}
    </Screen>
