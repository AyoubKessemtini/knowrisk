...
export const JournalScreen: React.FC = () => {
  ...
  const questionsData = [
        ...
        {
            category: 'Medication',
            questions: ['Did you miss any doses of your prescribed medication today?'],
        },
        {
    ...
    const handleDateChange = (newDate: Date) => {
        if(newDate>new Date()){
            Alert.alert('Date error',`Questions of (${formatStringDate(newDate)}) are not available.`)
        } else{
    ...
    return (
        ...
        >
            ...
            <View style={styles.wrapper}>
                ...
                />
                <CText style={{textAlign:'center'}} mt={20} mb={20} size={"md_light"} color={'grey3'}> What happened {formatStringDate(selectedDate)}</CText>
