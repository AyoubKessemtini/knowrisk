...
export const ChatBotScreen = ({}: RootStackScreenProps<'chatbot'>): JSX.Element => {
  const [messages, setMessages] = useState<IMessage[]>([
    {
      ...
      quickReplies: {
        type: 'radio',
        values: [
          { title: 'What are the risks of seizures?', value: 'What are the risks of seizures?' },
          { title: 'How can I prevent a seizure?', value: 'How can I prevent a seizure?' },
          { title: 'What should I do during a seizure?', value: 'What should I do during a seizure?' },
        ],
      },
    },
  ]);
  ...
  const quickReplyOptions: { [key: string]: QuickReply[] } = {
    default: [
      ...
      { title: 'How can Knowlepsy help?', value: 'How can Knowlepsy help me manage my health?' },
    ],
    stress: [
      { title: 'How can I reduce stress?', value: 'How can I reduce stress?' },
      { title: 'Can stress cause seizures?', value: 'Can stress cause seizures?' },
    ],
    seizure: [
      { title: 'What are common triggers?', value: 'What are the common seizure triggers?' },
      { title: 'What should I do during a seizure?', value: 'What should I do during a seizure?' },
    ],
  };
